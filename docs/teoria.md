...
3. [Mi primer modelo de aprendizaje](https://github.com/mcd-unison/aaa-curso/raw/main/slides/ejemplo_modelo.pdf) 

4. ¿Y porque esas funciones de activación y de costo? [Una presentación sobre GLM](https://github.com/mcd-unison/aaa-curso/raw/main/slides/glm.pdf)
...
6. [Presentación sobre validación](http://www.cs.rpi.edu/~magdon/courses/LFD-Slides/SlidesLect13.pdf) de [M. Magdon-Ismail](http://www.cs.rpi.edu/~magdon/)

7.  [Introducción a las MLOps](https://github.com/mcd-unison/aaa-curso/raw/main/slides/mlops_mlflow_intro.pdf).

8. [Presentación sobre el *overfiting*](http://www.cs.rpi.edu/~magdon/courses/LFD-Slides/SlidesLect11.pdf) de [M. Magdon-Ismail](http://www.cs.rpi.edu/~magdon/)

9. [Presentación sobre regularización](http://www.cs.rpi.edu/~magdon/courses/LFD-Slides/SlidesLect12.pdf) de [M. Magdon-Ismail](http://www.cs.rpi.edu/~magdon/)
...
2. [Como usar MLFlow para el seguimiento de experimentos de aprendizaje automático](https://github.com/mcd-unison/aaa-curso/blob/main/ejemplos/mlflow3-et.ipynb) 

3. [Comparación de modelos de clasificación](https://colab.research.google.com/github/mcd-unison/aaa-curso/blob/main/ejemplos/plot_classifier_comparison.ipynb)

4. [Un libreta sobre regresión lineal con regularización](https://colab.research.google.com/github/jakevdp/PythonDataScienceHandbook/blob/master/notebooks/05.06-Linear-Regression.ipynb)

5. [Una libreta para visualizar las diferentes opciones de validación cruzada que vienen en *scikit-learn*](https://github.com/mcd-unison/aaa-curso/blob/main/ejemplos/plot_cv_indices.ipynb)